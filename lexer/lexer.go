...
// This is the lexer for Monkey programming language.
...
func (l *Lexer) NextToken() token.Token {
	...
	default:
		if isLetter(l.ch) {
			...
			// readIdentifier()の呼び出しでl.chが更新されるので、
			// ここでreturnする必要がある。
			return tok
		}
		if isDigit(l.ch) {
...
// readChar reads a single character from the input and advances the position of the lexer.
...
// readIdentifier reads a sequence of letters and digits and returns it as a string.
...
// isLetter returns true if the given character is a letter or an underscore.
